...
const AdminOrderDetail = () => {
  ...
  const fetchOrderDetail = async () => {
    try {
      ...
      setSelectedPaymentStatus(transformedOrder.paymentStatus);
    } catch (error) {
  ...
  const handleUpdatePaymentStatus = async () => {
    if (
      ...
      toast.error("Vui lòng chọn trạng thái thanh toán mới");
      return;
    }

    try {
      setIsUpdating(true);
      await orderAPI.updatePaymentStatus(id, selectedPaymentStatus);
            ...
            <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="flex-1 btn btn-primary"
                  disabled={
                    isUpdating || selectedPaymentStatus === order.paymentStatus
                  }
                >
                  {isUpdating ? (
                    <div className="flex items-center justify-center">
