    ...
    <div className="w-full max-w-md">
      ...
      <div className="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="space-y-1 text-xs text-gray-600">
          <p><strong>Admin:</strong> admin@bachhoa.com / 123456</p>
          <p><strong>Staff:</strong> staff@bachhoa.com / 123456</p>
          <p><strong>Customer:</strong> customer@bachhoa.com / 123456</p>
        </div>
      </div>
