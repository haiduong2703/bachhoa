...
const ProductListPage = () => {
  ...
  useEffect(() => {
    console.log('ProductListPage: non-search filters changed, fetching products...', filters)
  ...
  // Initial load
  useEffect(() => {
    console.log('ProductListPage: initial load, fetching categories and products')
    fetchCategories()
    fetchProducts()
  }, [])
  ...
  const handleSearch = () => {
    console.log('ProductListPage: handleSearch called with value:', searchInput)
    ...
    if (searchTerm) {
      console.log('ProductListPage: calling fetchProducts with search:', searchTerm)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Khám phá các sản phẩm chất lượng cao tại Bach Hoa Store</p>
      </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                {[...Array(pagination?.totalPages || 0)].map((_, i) => {
                  ...
                  if (
                    ...
                    (page >= (pagination?.page || 1) - 2 && page <= (pagination?.page || 1) + 2)
                  ) {
                    return (
                      <button
                        key={page}
